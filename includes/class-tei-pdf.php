...
define('ANTHOLOGIZE_DIR', "WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'anthologize' . DIRECTORY_SEPARATOR")

include(ANTHOLOGIZE_DIR . 'templates' . DIRECTORY_SEPARATOR . 'pdf' . DIRECTORY_SEPARATOR . 'tcpdf' . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'lang' . DIRECTORY_SEPARATOR . 'eng.pdf');
include(ANTHOLOGIZE_DIR . 'templates' . DIRECTORY_SEPARATOR . 'pdf' . DIRECTORY_SEPARATOR . 'tcpdf' . DIRECTORY_SEPARATOR . 'tcpdf.php');
include(ANTHOLOGIZE_DIR . 'includes' . DIRECTORY_SEPARATOR . 'class-tei-dom.php');
