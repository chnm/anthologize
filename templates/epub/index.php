<?php
  ...
  require_once('class-epub-builder.php');
...
$ops['outputParams'] = $_SESSION['outputParams'];
  ...
  //$data = "<html><head><title>test</title></head><body><p>TEST</p></body></html>";
  ...
  $data = $epub_dir . "/tei2html.xsl";

//  $tei = new TeiDom($_SESSION, $ops);
//  $epub = new EpubBuilder($tei, $data);
