...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- START GLOBAL VARIABLES (as API to TEI intermediate format) -->
  ...
  <xsl:variable name="book.acknowledgements">
    <xsl:copy-of select="/tei:TEI/tei:text/tei:front/tei:*[@xml:id='f2']"/>
  </xsl:variable>

  <xsl:variable name="book.acknowledgements.text">
    <xsl:copy-of select="/tei:TEI/tei:text/tei:front/tei:*[@xml:id='f2']/html:body/node()"/>
  </xsl:variable>
